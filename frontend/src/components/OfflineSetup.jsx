...
export default function OfflineSetup({ setSetupComplete }) {
    ...
    const finishSetup = () => {
        localStorage.setItem("studyFlow-offline-setup", "true");
    ...
    return (
        <div className="offline-setup">
            ...
            <p>StudyFlow can run fully offline using Ollama & Gemma models.</p>
            {/* System Selection */}
            ...
            <div className="setup-section">
                ...
                <a href="https://ollama.com" target="blank" rel="noreferrer">
                    Download Ollama
                </a>
            </div>
            {/* Final Step */}
            <div className="setup-section">
                ...
                <p>Start your backend & frontend in your IDE, then continue to StudyFlow.</p>
                <pre>
                    cd backend
                    npm run dev
                </pre>
